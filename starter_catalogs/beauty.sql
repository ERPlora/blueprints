...
-- `services` depende de `taxes` (ADR-0066: el IVA se enlaza por tax_rate_id, no por % crudo), por
-- eso las filas de taxes_rate van PRIMERO y los servicios las referencian por id.
--
-- Esquema real verificado contra las migraciones de cada módulo (modules-workspace/modules/*):
--   taxes_rate(id, hub_id, code, name, category_id, parent_id, country_code, region_code, rate_pct,
--              tax_type, applies_from, applies_until, is_active, is_deleted, ...auditoría)
--   services_settings(id, hub_id, default_duration, default_buffer_time, default_tax_rate_id, ...)
...
--                    tax_rate_id, duration_minutes, ..., image, icon, color, is_bookable, ...)
...
-- ════════════════════════════════════════════════════════════════════════════════════════════
-- 1) IVA (taxes_rate). En España la peluquería tributa al IVA general 21 %. Sembramos también el
--    21 % (servicios) y el 10 % por si el salón vende algún producto a tipo reducido. country=ES.
-- ════════════════════════════════════════════════════════════════════════════════════════════
...
SELECT 'tax-beauty-iva21', '00000000-0000-0000-0000-000000000001', 'IVA21', 'IVA general 21%', NULL, NULL, 'ES', '', 21.0, 'vat', '2026-01-01', NULL, 1, 0, NULL, NULL, '2026-01-01T00:00:00+00:00', '2026-01-01T00:00:00+00:00'
...
INSERT INTO taxes_rate (id, hub_id, code, name, category_id, parent_id, country_code, region_code, rate_pct, tax_type, applies_from, applies_until, is_active, is_deleted, created_by, updated_by, created_at, updated_at)
SELECT 'tax-beauty-iva10', '00000000-0000-0000-0000-000000000001', 'IVA10', 'IVA reducido 10%', NULL, NULL, 'ES', '', 10.0, 'vat', '2026-01-01', NULL, 1, 0, NULL, NULL, '2026-01-01T00:00:00+00:00', '2026-01-01T00:00:00+00:00'
...
INSERT INTO services_settings (id, hub_id, default_duration, default_buffer_time, default_tax_rate_id, show_prices, show_duration, allow_online_booking, include_tax_in_price, currency, is_deleted, created_by, updated_by, created_at, updated_at)
SELECT 'svcset-beauty', '00000000-0000-0000-0000-000000000001', 45, 5, 'tax-beauty-iva21', 1, 1, 1, 1, 'EUR', 0, NULL, NULL, '2026-01-01T00:00:00+00:00', '2026-01-01T00:00:00+00:00'
...
-- ════════════════════════════════════════════════════════════════════════════════════════════
-- 4) Servicios (services_service). price = CÉNTIMOS (ADR-0007). tax_rate_id → IVA 21 %.
--    image = s3_key relativa de la librería beauty (assets/beauty_hair|beauty_body/*.webp).
--    pricing_type: 'fixed' precio cerrado | 'from' "desde" (color/mechas varían por melena).
-- ════════════════════════════════════════════════════════════════════════════════════════════

-- Corte y peinado
INSERT INTO services_service (id, hub_id, name, slug, description, short_description, category_id, pricing_type, price, min_price, max_price, cost, tax_rate_id, duration_minutes, buffer_before, buffer_after, max_capacity, image, icon, color, is_bookable, requires_confirmation, allow_online_booking, sort_order, is_active, is_featured, sku, barcode, notes, is_deleted, created_by, updated_by, created_at, updated_at)
SELECT 'svc-beauty-corte_senora', '00000000-0000-0000-0000-000000000001', 'Corte de señora', 'corte-senora', '', '', 'cat-beauty-corte', 'fixed', 1800, NULL, NULL, 0, 'tax-beauty-iva21', 45, 0, 5, 1, 'assets/beauty_hair/corte_senora.webp', '', '', 1, 0, 1, 0, 1, 1, 'corte_senora', '', '', 0, NULL, NULL, '2026-01-01T00:00:00+00:00', '2026-01-01T00:00:00+00:00'
WHERE NOT EXISTS (SELECT 1 FROM services_service WHERE hub_id = '00000000-0000-0000-0000-000000000001' AND slug = 'corte-senora');
INSERT INTO services_service (id, hub_id, name, slug, description, short_description, category_id, pricing_type, price, min_price, max_price, cost, tax_rate_id, duration_minutes, buffer_before, buffer_after, max_capacity, image, icon, color, is_bookable, requires_confirmation, allow_online_booking, sort_order, is_active, is_featured, sku, barcode, notes, is_deleted, created_by, updated_by, created_at, updated_at)
SELECT 'svc-beauty-corte_caballero', '00000000-0000-0000-0000-000000000001', 'Corte de caballero', 'corte-caballero', '', '', 'cat-beauty-corte', 'fixed', 1400, NULL, NULL, 0, 'tax-beauty-iva21', 30, 0, 5, 1, 'assets/beauty_hair/corte_caballero.webp', '', '', 1, 0, 1, 1, 1, 0, 'corte_caballero', '', '', 0, NULL, NULL, '2026-01-01T00:00:00+00:00', '2026-01-01T00:00:00+00:00'
...
INSERT INTO services_service (id, hub_id, name, slug, description, short_description, category_id, pricing_type, price, min_price, max_price, cost, tax_rate_id, duration_minutes, buffer_before, buffer_after, max_capacity, image, icon, color, is_bookable, requires_confirmation, allow_online_booking, sort_order, is_active, is_featured, sku, barcode, notes, is_deleted, created_by, updated_by, created_at, updated_at)
SELECT 'svc-beauty-corte_nino', '00000000-0000-0000-0000-000000000001', 'Corte infantil', 'corte-infantil', '', '', 'cat-beauty-corte', 'fixed', 1100, NULL, NULL, 0, 'tax-beauty-iva21', 30, 0, 5, 1, 'assets/beauty_hair/corte_nino.webp', '', '', 1, 0, 1, 2, 1, 0, 'corte_nino', '', '', 0, NULL, NULL, '2026-01-01T00:00:00+00:00', '2026-01-01T00:00:00+00:00'
...
INSERT INTO services_service (id, hub_id, name, slug, description, short_description, category_id, pricing_type, price, min_price, max_price, cost, tax_rate_id, duration_minutes, buffer_before, buffer_after, max_capacity, image, icon, color, is_bookable, requires_confirmation, allow_online_booking, sort_order, is_active, is_featured, sku, barcode, notes, is_deleted, created_by, updated_by, created_at, updated_at)
SELECT 'svc-beauty-lavado_peinado', '00000000-0000-0000-0000-000000000001', 'Lavar y peinar', 'lavar-peinar', '', '', 'cat-beauty-corte', 'fixed', 1500, NULL, NULL, 0, 'tax-beauty-iva21', 30, 0, 5, 1, 'assets/beauty_hair/lavado_secado.webp', '', '', 1, 0, 1, 3, 1, 0, 'lavado_peinado', '', '', 0, NULL, NULL, '2026-01-01T00:00:00+00:00', '2026-01-01T00:00:00+00:00'
WHERE NOT EXISTS (SELECT 1 FROM services_service WHERE hub_id = '00000000-0000-0000-0000-000000000001' AND slug = 'lavar-peinar');
INSERT INTO services_service (id, hub_id, name, slug, description, short_description, category_id, pricing_type, price, min_price, max_price, cost, tax_rate_id, duration_minutes, buffer_before, buffer_after, max_capacity, image, icon, color, is_bookable, requires_confirmation, allow_online_booking, sort_order, is_active, is_featured, sku, barcode, notes, is_deleted, created_by, updated_by, created_at, updated_at)
SELECT 'svc-beauty-recogido', '00000000-0000-0000-0000-000000000001', 'Recogido / peinado evento', 'recogido', '', '', 'cat-beauty-corte', 'from', 3500, 3500, NULL, 0, 'tax-beauty-iva21', 60, 0, 10, 1, 'assets/beauty_hair/recogido.webp', '', '', 1, 1, 1, 4, 1, 0, 'recogido', '', '', 0, NULL, NULL, '2026-01-01T00:00:00+00:00', '2026-01-01T00:00:00+00:00'
...
INSERT INTO services_service (id, hub_id, name, slug, description, short_description, category_id, pricing_type, price, min_price, max_price, cost, tax_rate_id, duration_minutes, buffer_before, buffer_after, max_capacity, image, icon, color, is_bookable, requires_confirmation, allow_online_booking, sort_order, is_active, is_featured, sku, barcode, notes, is_deleted, created_by, updated_by, created_at, updated_at)
SELECT 'svc-beauty-tinte_completo', '00000000-0000-0000-0000-000000000001', 'Tinte completo', 'tinte-completo', '', '', 'cat-beauty-color', 'from', 3200, 3200, NULL, 0, 'tax-beauty-iva21', 75, 0, 10, 1, 'assets/beauty_hair/tinte_completo.webp', '', '', 1, 0, 1, 0, 1, 1, 'tinte_completo', '', '', 0, NULL, NULL, '2026-01-01T00:00:00+00:00', '2026-01-01T00:00:00+00:00'
...
INSERT INTO services_service (id, hub_id, name, slug, description, short_description, category_id, pricing_type, price, min_price, max_price, cost, tax_rate_id, duration_minutes, buffer_before, buffer_after, max_capacity, image, icon, color, is_bookable, requires_confirmation, allow_online_booking, sort_order, is_active, is_featured, sku, barcode, notes, is_deleted, created_by, updated_by, created_at, updated_at)
SELECT 'svc-beauty-tinte_raiz', '00000000-0000-0000-0000-000000000001', 'Retoque de raíz', 'tinte-raiz', '', '', 'cat-beauty-color', 'fixed', 2500, NULL, NULL, 0, 'tax-beauty-iva21', 60, 0, 10, 1, 'assets/beauty_hair/tinte_raiz.webp', '', '', 1, 0, 1, 1, 1, 0, 'tinte_raiz', '', '', 0, NULL, NULL, '2026-01-01T00:00:00+00:00', '2026-01-01T00:00:00+00:00'
WHERE NOT EXISTS (SELECT 1 FROM services_service WHERE hub_id = '00000000-0000-0000-0000-000000000001' AND slug = 'tinte-raiz');
INSERT INTO services_service (id, hub_id, name, slug, description, short_description, category_id, pricing_type, price, min_price, max_price, cost, tax_rate_id, duration_minutes, buffer_before, buffer_after, max_capacity, image, icon, color, is_bookable, requires_confirmation, allow_online_booking, sort_order, is_active, is_featured, sku, barcode, notes, is_deleted, created_by, updated_by, created_at, updated_at)
SELECT 'svc-beauty-mechas', '00000000-0000-0000-0000-000000000001', 'Mechas', 'mechas', '', '', 'cat-beauty-color', 'from', 4500, 4500, NULL, 0, 'tax-beauty-iva21', 120, 0, 10, 1, 'assets/beauty_hair/mechas.webp', '', '', 1, 0, 1, 2, 1, 1, 'mechas', '', '', 0, NULL, NULL, '2026-01-01T00:00:00+00:00', '2026-01-01T00:00:00+00:00'
WHERE NOT EXISTS (SELECT 1 FROM services_service WHERE hub_id = '00000000-0000-0000-0000-000000000001' AND slug = 'mechas');
INSERT INTO services_service (id, hub_id, name, slug, description, short_description, category_id, pricing_type, price, min_price, max_price, cost, tax_rate_id, duration_minutes, buffer_before, buffer_after, max_capacity, image, icon, color, is_bookable, requires_confirmation, allow_online_booking, sort_order, is_active, is_featured, sku, barcode, notes, is_deleted, created_by, updated_by, created_at, updated_at)
SELECT 'svc-beauty-balayage', '00000000-0000-0000-0000-000000000001', 'Balayage', 'balayage', '', '', 'cat-beauty-color', 'from', 6500, 6500, NULL, 0, 'tax-beauty-iva21', 150, 0, 10, 1, 'assets/beauty_hair/mechas_balayage.webp', '', '', 1, 1, 1, 3, 1, 0, 'balayage', '', '', 0, NULL, NULL, '2026-01-01T00:00:00+00:00', '2026-01-01T00:00:00+00:00'
WHERE NOT EXISTS (SELECT 1 FROM services_service WHERE hub_id = '00000000-0000-0000-0000-000000000001' AND slug = 'balayage');

-- Tratamientos capilares
INSERT INTO services_service (id, hub_id, name, slug, description, short_description, category_id, pricing_type, price, min_price, max_price, cost, tax_rate_id, duration_minutes, buffer_before, buffer_after, max_capacity, image, icon, color, is_bookable, requires_confirmation, allow_online_booking, sort_order, is_active, is_featured, sku, barcode, notes, is_deleted, created_by, updated_by, created_at, updated_at)
SELECT 'svc-beauty-keratina', '00000000-0000-0000-0000-000000000001', 'Tratamiento de keratina', 'keratina', '', '', 'cat-beauty-tratamientos', 'from', 6000, 6000, NULL, 0, 'tax-beauty-iva21', 120, 0, 10, 1, 'assets/beauty_hair/keratina.webp', '', '', 1, 1, 1, 0, 1, 0, 'keratina', '', '', 0, NULL, NULL, '2026-01-01T00:00:00+00:00', '2026-01-01T00:00:00+00:00'
WHERE NOT EXISTS (SELECT 1 FROM services_service WHERE hub_id = '00000000-0000-0000-0000-000000000001' AND slug = 'keratina');
INSERT INTO services_service (id, hub_id, name, slug, description, short_description, category_id, pricing_type, price, min_price, max_price, cost, tax_rate_id, duration_minutes, buffer_before, buffer_after, max_capacity, image, icon, color, is_bookable, requires_confirmation, allow_online_booking, sort_order, is_active, is_featured, sku, barcode, notes, is_deleted, created_by, updated_by, created_at, updated_at)
SELECT 'svc-beauty-hidratacion', '00000000-0000-0000-0000-000000000001', 'Tratamiento hidratación', 'hidratacion', '', '', 'cat-beauty-tratamientos', 'fixed', 2000, NULL, NULL, 0, 'tax-beauty-iva21', 45, 0, 5, 1, 'assets/beauty_hair/hidratacion.webp', '', '', 1, 0, 1, 1, 1, 0, 'hidratacion', '', '', 0, NULL, NULL, '2026-01-01T00:00:00+00:00', '2026-01-01T00:00:00+00:00'
WHERE NOT EXISTS (SELECT 1 FROM services_service WHERE hub_id = '00000000-0000-0000-0000-000000000001' AND slug = 'hidratacion');

-- Barbería
INSERT INTO services_service (id, hub_id, name, slug, description, short_description, category_id, pricing_type, price, min_price, max_price, cost, tax_rate_id, duration_minutes, buffer_before, buffer_after, max_capacity, image, icon, color, is_bookable, requires_confirmation, allow_online_booking, sort_order, is_active, is_featured, sku, barcode, notes, is_deleted, created_by, updated_by, created_at, updated_at)
SELECT 'svc-beauty-arreglo_barba', '00000000-0000-0000-0000-000000000001', 'Arreglo de barba', 'arreglo-barba', '', '', 'cat-beauty-barberia', 'fixed', 1000, NULL, NULL, 0, 'tax-beauty-iva21', 20, 0, 5, 1, 'assets/beauty_hair/perfilado_barba.webp', '', '', 1, 0, 1, 0, 1, 0, 'arreglo_barba', '', '', 0, NULL, NULL, '2026-01-01T00:00:00+00:00', '2026-01-01T00:00:00+00:00'
WHERE NOT EXISTS (SELECT 1 FROM services_service WHERE hub_id = '00000000-0000-0000-0000-000000000001' AND slug = 'arreglo-barba');
INSERT INTO services_service (id, hub_id, name, slug, description, short_description, category_id, pricing_type, price, min_price, max_price, cost, tax_rate_id, duration_minutes, buffer_before, buffer_after, max_capacity, image, icon, color, is_bookable, requires_confirmation, allow_online_booking, sort_order, is_active, is_featured, sku, barcode, notes, is_deleted, created_by, updated_by, created_at, updated_at)
SELECT 'svc-beauty-afeitado_navaja', '00000000-0000-0000-0000-000000000001', 'Afeitado a navaja', 'afeitado-navaja', '', '', 'cat-beauty-barberia', 'fixed', 1500, NULL, NULL, 0, 'tax-beauty-iva21', 30, 0, 5, 1, 'assets/beauty_hair/afeitado_navaja.webp', '', '', 1, 0, 1, 1, 1, 0, 'afeitado_navaja', '', '', 0, NULL, NULL, '2026-01-01T00:00:00+00:00', '2026-01-01T00:00:00+00:00'
...
-- Manicura y pedicura
INSERT INTO services_service (id, hub_id, name, slug, description, short_description, category_id, pricing_type, price, min_price, max_price, cost, tax_rate_id, duration_minutes, buffer_before, buffer_after, max_capacity, image, icon, color, is_bookable, requires_confirmation, allow_online_booking, sort_order, is_active, is_featured, sku, barcode, notes, is_deleted, created_by, updated_by, created_at, updated_at)
SELECT 'svc-beauty-manicura', '00000000-0000-0000-0000-000000000001', 'Manicura básica', 'manicura-basica', '', '', 'cat-beauty-unas', 'fixed', 1500, NULL, NULL, 0, 'tax-beauty-iva21', 30, 0, 5, 1, 'assets/beauty_body/manicura_basica.webp', '', '', 1, 0, 1, 0, 1, 0, 'manicura_basica', '', '', 0, NULL, NULL, '2026-01-01T00:00:00+00:00', '2026-01-01T00:00:00+00:00'
...
INSERT INTO services_service (id, hub_id, name, slug, description, short_description, category_id, pricing_type, price, min_price, max_price, cost, tax_rate_id, duration_minutes, buffer_before, buffer_after, max_capacity, image, icon, color, is_bookable, requires_confirmation, allow_online_booking, sort_order, is_active, is_featured, sku, barcode, notes, is_deleted, created_by, updated_by, created_at, updated_at)
SELECT 'svc-beauty-manicura_semi', '00000000-0000-0000-0000-000000000001', 'Manicura semipermanente', 'manicura-semipermanente', '', '', 'cat-beauty-unas', 'fixed', 2200, NULL, NULL, 0, 'tax-beauty-iva21', 45, 0, 5, 1, 'assets/beauty_body/manicura_semipermanente.webp', '', '', 1, 0, 1, 1, 1, 0, 'manicura_semi', '', '', 0, NULL, NULL, '2026-01-01T00:00:00+00:00', '2026-01-01T00:00:00+00:00'
...
INSERT INTO services_service (id, hub_id, name, slug, description, short_description, category_id, pricing_type, price, min_price, max_price, cost, tax_rate_id, duration_minutes, buffer_before, buffer_after, max_capacity, image, icon, color, is_bookable, requires_confirmation, allow_online_booking, sort_order, is_active, is_featured, sku, barcode, notes, is_deleted, created_by, updated_by, created_at, updated_at)
SELECT 'svc-beauty-pedicura', '00000000-0000-0000-0000-000000000001', 'Pedicura básica', 'pedicura-basica', '', '', 'cat-beauty-unas', 'fixed', 1800, NULL, NULL, 0, 'tax-beauty-iva21', 45, 0, 5, 1, 'assets/beauty_body/pedicura_basica.webp', '', '', 1, 0, 1, 2, 1, 0, 'pedicura_basica', '', '', 0, NULL, NULL, '2026-01-01T00:00:00+00:00', '2026-01-01T00:00:00+00:00'
...
INSERT INTO services_service (id, hub_id, name, slug, description, short_description, category_id, pricing_type, price, min_price, max_price, cost, tax_rate_id, duration_minutes, buffer_before, buffer_after, max_capacity, image, icon, color, is_bookable, requires_confirmation, allow_online_booking, sort_order, is_active, is_featured, sku, barcode, notes, is_deleted, created_by, updated_by, created_at, updated_at)
SELECT 'svc-beauty-depilacion_cejas', '00000000-0000-0000-0000-000000000001', 'Depilación / diseño de cejas', 'depilacion-cejas', '', '', 'cat-beauty-estetica', 'fixed', 800, NULL, NULL, 0, 'tax-beauty-iva21', 15, 0, 5, 1, 'assets/beauty_body/tinte_cejas.webp', '', '', 1, 0, 1, 0, 1, 0, 'depilacion_cejas', '', '', 0, NULL, NULL, '2026-01-01T00:00:00+00:00', '2026-01-01T00:00:00+00:00'
...
INSERT INTO services_service (id, hub_id, name, slug, description, short_description, category_id, pricing_type, price, min_price, max_price, cost, tax_rate_id, duration_minutes, buffer_before, buffer_after, max_capacity, image, icon, color, is_bookable, requires_confirmation, allow_online_booking, sort_order, is_active, is_featured, sku, barcode, notes, is_deleted, created_by, updated_by, created_at, updated_at)
SELECT 'svc-beauty-limpieza_facial', '00000000-0000-0000-0000-000000000001', 'Limpieza facial', 'limpieza-facial', '', '', 'cat-beauty-estetica', 'fixed', 3500, NULL, NULL, 0, 'tax-beauty-iva21', 60, 0, 10, 1, 'assets/beauty_body/limpieza_facial.webp', '', '', 1, 0, 1, 1, 1, 0, 'limpieza_facial', '', '', 0, NULL, NULL, '2026-01-01T00:00:00+00:00', '2026-01-01T00:00:00+00:00'
